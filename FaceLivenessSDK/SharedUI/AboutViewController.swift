...
final class AboutViewController: UIViewController {
    override func viewDidLoad() {
        ...
        let product = UILabel()
        product.text = "Face Liveness SDK"
        ...
        let productBody = cardLabel(
            "This app demos the Face Liveness SDK for iOS: passive 2D liveness on live camera. Everything runs fully on-premise."
        )
